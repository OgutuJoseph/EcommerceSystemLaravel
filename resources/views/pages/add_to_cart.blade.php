            ...
            <div class="col-sm-6">
                <div class="total_area">
                    <ul>
						...
						<a class="btn btn-default check_out" href="{{URL::to('/checkout')}}"><i class="fa fa-crosshairs"></i> Checkout</a>
						<?php }else{?>
						<a class="btn btn-default check_out" href="{{URL::to('/login-check')}}"><i class="fa fa-crosshairs"></i> Checkout</a>
						<?php } ?> 
                </div>
            </div>
        </div>
