        ...
        <div class="product-image-wrapper">
            <div class="single-products">
                    <div class="productinfo text-center">
                        <img src="{{ asset($v_manufacture_by_product->product_image) }}" alt="" style="height: 150px; width: 150px;" />
                        <h2>{{$v_manufacture_by_product->product_price}} KES/-</h2>
            ...
            <div class="choose">
                <ul class="nav nav-pills nav-justified">
                    <li><a href="{{URL::to('/view_product/'.$v_manufacture_by_product->product_id)}}"><i class="fa fa-plus-square"></i>{{ $v_manufacture_by_product->product_name }}</a></li> 
                </ul>
            </div>
        </div>
    </div>
