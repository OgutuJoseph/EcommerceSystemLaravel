...
<head>
	...
	<!-- start: Favicon -->
	<link rel="shortcut icon" href="{{ asset('backend1/img/favicon.ico') }}">
	<!-- end: Favicon -->
...
<body>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown hidden-phone">
							...
							<ul class="dropdown-menu messages">
                            	...
                            	<li>
                                    <a href="#">
										<span class="avatar"><img src="{{ asset('backend1/img/avatar.jpg') }}" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Dennis Ji
										     </span>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <li>
							<a class="dropmenu" href="#"><i class="icon-envelope"></i><span class="hidden-tablet">Categories</span><span class="label label-important"></span></a>
							<ul>
                        ...
                        <li>
							<a class="dropmenu" href="#"><i class="icon-tasks"></i><span class="hidden-tablet"> Manufactures</span><span class="label label-important"></span></a>
							<ul>
								<li><a class="submenu" href="{{ URL::to('/all-manufacture') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Manufactures</span></a></li>
                        ...
                        <li>
							<a class="dropmenu" href="#"><i class="icon-list-alt"></i><span class="hidden-tablet"> Sliders</span><span class="label label-important"></span></a>
							<ul>
						...
						<li><a href="{{ URL::to('/manage-order') }}"><i class="icon-eye-open"></i><span class="hidden-tablet"> Manage Orders</span></a></li>
                        <li><a href="widgets.html"><i class="icon-dashboard"></i><span class="hidden-tablet"> Shop Name</span></a></li>
                        <li><a href="widgets.html"><i class="icon-picture"></i><span class="hidden-tablet"> Delivery Man</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
	...
	<script src="{{ asset('backend1/js/jquery.cookie.js') }}"></script> 
